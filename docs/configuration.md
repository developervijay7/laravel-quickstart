...
We maintained all configuration in a separate section in your .env file make sure to configure them properly.
...
#Laravel Quick-Start Configuration
DEBUGBAR_ENABLED=true
FORCE_HTTPS=false
GOOGLE_TAG_MANAGER=GTM-PW5NKV9
...
TWITTER_HANDLE=https://www.twitter.com
...
And take a look at config/quickstart.php
```php
