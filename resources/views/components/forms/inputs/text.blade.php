...
@isset($errors)
    ...
    @else
    <input id="{{ $id }}" name="{{ $name }}" type="text" {{ $attributes->merge(['class' => 'appearance-none text-md p-2 focus:outline-none border-2 focus:ring-blue-600 focus:border-blue-600 dark:bg-gray-900 text-purple-900 dark:text-gray-100 placeholder-purple-300 dark:placeholder-gray-600 font-semibold']) }}>
    @enderror
