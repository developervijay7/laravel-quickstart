    ...
    <section class="my-24">
        <div class="container">
            <div class="px-6">
                ...
                <p></p>
                <div class="my-12 grid grid-cols-2 md:grid-cols-6 gap-6">
                    ...
                    <a href="http://docs.laravel-quickstart.co" class="bg-red-400 px-5 py-2 rounded shadow opacity-80 hover:opacity-100 prevent-external" target="_blank">Documentation</a>
                </div>
            </div>
        </div>
    </section>
